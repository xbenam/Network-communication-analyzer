...
empty_pck = {'frame_number': Optional[int],
             'len_frame_pcap': Optional[int],
             'len_frame_medium': Optional[int],
             'frame_type': Optional[str],
             'src_mac': Optional[str],
             'dst_mac': Optional[str],
             'hexa_frame': Optional[str]}

# slovník ktorý v sebe bude mat všetky údaje, ktoré pôjdu do yaml súboru
empty_yaml = {'name': Optional[str],
              'pcap_name': Optional[str],
              'packets': []}
